...
const Untitled4 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><Text style={styles.BynFPKFd}>{"regression testing "}</Text><ImageBackground style={styles.AGLreZmV} source={{
      ...
      }} resizeMode="cover"></ImageBackground><ActivityIndicator style={styles.byASCaCK}></ActivityIndicator><RadioGroup style={styles.HPKEbybT} radioButtons={[{
        id: "1",
        label: "Option 1",
        value: "option1"
      }, {
        ...
        label: "Option 2",
        value: "option2"
      }]} layout="column"></RadioGroup><Slider style={styles.WcnQWmyd} thumbStyle={{
        height: 20,
        width: 20
